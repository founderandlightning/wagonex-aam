...
function aam_home_post() {
	$labels = array(
	  ...
	  'search_items'       => __( 'Search Home Sections' ),
	  'not_found'          => __( 'No home section found' ),
	  'not_found_in_trash' => __( 'No home section found in the Trash' ), 
	  'parent_item_colon'  => '',
	  'menu_name'          => 'Home Sections'
	);
	$args = array(
	  'labels'        => $labels,
	  'description'   => 'Holds home sections and home section specific data',
	  'public'        => true,
	  'menu_position' => 5,
